...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Hauslife | <?php echo $pageTitle;?></title>
      ...
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <?php } else {?>
              <a href="verInformacion.php?<?php echo $usuariologueado['_id'];?>" class="navbar-link"><?php echo $usuariologueado['nombre'];?></a>
          <?php }?>
            ...
            <?php if($tipo==0){?>
						<li class="dropdown"><a id="drop1" href="#" role="button"
							...
							<ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
								<li><a href="../views/listaResidentes.php">Lista de residentes</a></li>
								<li><a href="../views/registraResidente.php">Registrar residente</a></li>
							</ul>
						</li>
						<li class="dropdown"><a id="drop1" href="#" role="button"
